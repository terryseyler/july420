...
def index():
    ...
    data_2022 = cursor.execute("""with ranks as
                                ...
                                from july2022
                                where   datetime(datetime,'-4 hours') between '2022-07-01 09:00:00' and '2022-07-01 19:00:00'
                                    or  datetime(datetime,'-4 hours') between '2022-07-02 09:00:00' and '2022-07-02 19:00:00'
                                    or  datetime(datetime,'-4 hours') between '2022-07-03 09:00:00' and '2022-07-03 19:00:00'
                                    or  datetime(datetime,'-4 hours') between '2022-07-04 09:00:00' and '2022-07-04 19:00:00'
                               order by datetime
                               limit 420
                               )
